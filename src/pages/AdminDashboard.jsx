...
// ✅ Proper initial posts
const initialPosts = [
  {
    id: 1,
    title: "Welcome Post",
    summary: "This is your first post",
    content: "Edit or delete this post in the Admin Dashboard.",
...
const AdminDashboard = () => {
  ...
  const bulkToggle = () => {
    ...
    setPosts((prev) =>
      prev.map((p) => ({ ...p, published: !allPublished }))
    );
  };
  ...
  ({
    ...
    <div className={styles.dashboard}>
      ...
      <form className={styles.form} onSubmit={handleSubmit}>
        ...
        />
        <button type="submit">
          {formData.id === null ? "Create" : "Update"} Post
        </button>
      </form>
      ...
      <div className={styles.controls}>
        ...
        <button
          ...
          className={currentFilter === "published" ? styles.active : ""}
        >
          Published
        </button>
        <button
          onClick={() => setFilter("unpublished")}
          className={currentFilter === "unpublished" ? styles.active : ""}
        >
          Unpublished
        </button>
